        ...
        <div class="col-md-12 column">
            <center><div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title"><? echo L('shake')?></h3>
                    </div>
            ...
            <table class="table table-striped table-bordered white-bg">
                <form action="index.php?m=admin&c=index&a=topic_add&tpl=topic" method="post">
                    ...
                    <tr>
                        <th colspan="2"><center><? echo L('EditPageInformation')?></center></th>
                    </tr>
                    ...
                    <th><?echo L('description')?></th>
                    <td>
                        <input type="text" class="form-control" name="description" id="description" /></td>
                    </tr> </tr>



                    <th><?echo L('page_url')?></th>
                    <td><input type="text" class="form-control" name="page_url" id="page_url" /></td>
                    </tr>
                    <tr>
                        <td colspan="2"><button class="btn btn-success btn-block"><? echo L('update')?></button></td>
                    </tr>
