        ...
        <div class="col-md-12 column">
            <center><div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?echo L('wechat_wall_user')?></h3>
                    </div>
            ...
            <table class="table table-striped table-bordered white-bg">
               ...
               if(isset($_SESSION['loginstatus'])){
                ...
                <tr>
                    ...
                    <td><?=$info['openid']?></td>
                    <td><?=$info['nickname']?></td>
                    <td><?if($info['sex']==1){echo"男";}else{echo"女";}
                        ?></td>
                ...
                ?>
                <tr><? //if(empty($page) || $page=1) {
                    //}else{
                    ?>
                    <a href="index.php?m=admin&c=index&tpl=user&page=<? echo $page-1;?>&tp_id=<?=$tp_id?>" class="btn btn-success btn-xs" ><? echo L('Previous')?></a>
                   <?//} ?>
                    <a href="index.php?m=admin&c=index&tpl=user&page=<? echo $page+1;?>&tp_id=<?=$tp_id?>" class="btn  btn-danger btn-xs"><? echo L('NextPage')?><a/>&nbsp;&nbsp;<? echo L('go_to')?>
                        <input style="width:5%" name="p"><? echo L('page')?><a href="index.php?m=admin&c=index&tpl=user&page=<?=$_POST['p']?>&tp_id=<?=$tp_id?>"class="btn btn-success btn-xs">GO</a>
                        &nbsp;&nbsp;&nbsp;<? echo L('currentPage'); if(isset($page)){echo$page; }else{echo 1;}?>&nbsp;&nbsp;&nbsp;
                </tr>
            </table>
